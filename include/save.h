...
#define SECTOR_DATA_SIZE 4084 //was 3968 but was changed due to decreasing footer size.
#define SECTOR_FOOTER_SIZE 12 //was 128 but only 12 bytes are actually used.
