...
const u32 gItemIcon_Divingsuit[] = INCBIN_U32("graphics/items/icons/divingsuit.4bpp.lz");
const u32 gItemIconPalette_Divingsuit[] = INCBIN_U32("graphics/items/icon_palettes/divingsuit.gbapal.lz");
const u32 gItemIcon_Powerglove[] = INCBIN_U32("graphics/items/icons/powerglove.4bpp.lz");
const u32 gItemIconPalette_Powerglove[] = INCBIN_U32("graphics/items/icon_palettes/powerglove.gbapal.lz");
